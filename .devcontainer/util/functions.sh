...
deployAstroshopNginx(){
  ...
  printInfo "Deploying Astroshop Nginx components to 'astroshop' namespace"
  kubectl apply -f $CODESPACE_VSCODE_FOLDER/.devcontainer/astroshop/astroshop-nginxproxy.yaml -n astroshop
